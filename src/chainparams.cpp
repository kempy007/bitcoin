...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTime, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vin.resize(1);
    txNew.vout.resize(1);
    txNew.vin[0].scriptSig = CScript() << 486604799 /*0x1d00ffff */ << CScriptNum(4) << std::vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
...
{
    const char* pszTimestamp = /*"Consider Web 3.0 to be an executable Magna Carta - the foundation of the freedom of the individual against the arbitrary authority of the despot."; //*/"The Times 03/Jan/2009 Chancellor on brink of second bailout for banks";
...
public:
    CMainParams() {
        ...
        consensus.MinBIP9WarningHeight = 0; // 483840; // segwit activation height + miner confirmation window
        ...
        nDefaultPort = 39619; // 8333;
        nPruneAfterHeight = 100000;
        m_assumed_blockchain_size = 420;
        m_assumed_chain_state_size = 6;

        genesis = CreateGenesisBlock(1231006505 /*373815420*/, 2083236893 /*4056809*/, 0x1d00ffff, 1, 50 * COIN);
        ...
        chainTxData = ChainTxData{
            ...
            /* nTime    */ 0, // 1626697539,
            /* nTxCount */ 0, // 656509474,
            /* dTxRate  */ 0,  // 2.424920418708139,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        consensus.signet_challenge.clear();
        consensus.nSubsidyHalvingInterval = 210000;
        consensus.BIP16Exception = uint256{}; // uint256S("0x00000000dd30457c001f4095d208cc1296b0eed002427aa599874af7a432b105");
        ...
        consensus.CSVHeight = 1; // 770112; // 00000000025e930139bac5c6c31a403776da130831ab85be56578f3fa75369bb
        consensus.SegwitHeight = 1; // 834624; // 00000000002b980fcd729daaa248fd9316a5200e9b367f4ff2c42453e84201ca
